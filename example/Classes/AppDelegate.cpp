...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if (!glview) {
        ...
        glview = GLViewImpl::createWithRect("examples", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
...
//    adjustConfig.setSendInBackground(true);
    ...
    Adjust2dx::addSessionPartnerParameter("sppk1", "sppv1");
    Adjust2dx::addSessionPartnerParameter("sppk2", "sppv2");

    Adjust2dx::removeSessionCallbackParameter("scpk1");
    Adjust2dx::removeSessionPartnerParameter("sppk2");
