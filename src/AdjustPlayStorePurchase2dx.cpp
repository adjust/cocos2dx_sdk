...
void AdjustPlayStorePurchase2dx::initPurchase(std::string productId, std::string purchaseToken) {
    ...
    if (!cocos2d::JniHelper::getMethodInfo(jmiInit, "com/adjust/sdk/AdjustPurchase", "<init>", "(JLjava/lang/String;Ljava/lang/String;)V")) {
        return;
    }

    jclass jclsAdjustPurchase = jmiInit.env->FindClass("com/adjust/sdk/AdjustPurchase");
    jmethodID jmidInit = jmiInit.env->GetMethodID(jclsAdjustPurchase, "<init>", "(JLjava/lang/String;Ljava/lang/String;)V");
